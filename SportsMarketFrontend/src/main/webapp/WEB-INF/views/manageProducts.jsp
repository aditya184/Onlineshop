              ...
              method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-md-8">
                             ...
                             <sf:textarea path="description" id="description" rows="4" placeholder="Write Product Description" class="form-control"/>
       ...
       class="form-horizontal">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
             ...
             <div class="col-md-8">
              <sf:textarea cols="" rows="5" path="desc" id="category_description" class="form-control"/>
