...
import com.aditya.SportsMarketFrontend.util.FileUploadUtility;
import com.aditya.SportsMarketFrontend.validator.ProductValidator;
...
public class ManagementController {
	...
	public ModelAndView showManageProducts(@RequestParam(name="operation",required=false)String operation)
   {
	...
	public String handleProductActivation(@PathVariable int id){
		...
		return (isActive)? "You have successfully deactivated th product with id " + product.getId() : "You have successfully activated th product with id " + product.getId() ;
	}
